...
@Component({
  selector: 'app-update-pending-product',
  templateUrl: './update-pending-product.component.html',
  styleUrls: ['./update-pending-product.component.scss']
})
export class UpdatePendingProductComponent implements OnInit {
  files: File[] = [];
  product_id:string
  product : any
