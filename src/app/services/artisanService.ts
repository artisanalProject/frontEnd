...
export class artisanService {
  ...
  createArtisant(body) {
    return this.http.post(this.baseUrl + "/artisant/createArtisant", body);
  }
  ...
  NotActivatedAccounts() {
    return this.http.get(
      this.baseUrl + "/artisant/NotActivatedAccounts",
      this.options
    );
  }
  activateAccount(idArtisant) {
    return this.http.get(
      this.baseUrl + "/artisant/activateAccount/" + idArtisant,
      this.options
    );
  }
  ...
  public nb() {
    this.NotActivatedAccounts().subscribe(
      (res) => {
        this.nbNotif = JSON.parse(JSON.stringify(res)).length;
      },
      (err) => {},
      () => {
